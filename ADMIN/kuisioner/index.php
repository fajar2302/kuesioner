<section class="kuesioner">
    ...
    <div class="row-justify-content-center ">
        <button type="button" class="btn add-button mx-3 my-3" id="callModalAddKuisioner" data-toggle="tooltip" data-placement="top" title="Tambah data baru"><i class="fas fa-plus"></i> Tambah Kuisioner</button>
        <!-- modals -->
