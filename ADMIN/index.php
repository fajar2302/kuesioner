...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <form action="" method="GET" class="d-flex ms-auto">
                    <div class="input-group my-3 my-lg-0">
                        <input type="text" class="form-control" placeholder="Masukkan Nama" aria-label="Masukkan" aria-describedby="button-addon2" name="cari" />
                ...
                <ul class="navbar-nav mb-2 mb-lg-0">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="../login/logout.php"><span class="me-2"><i class="bi bi-box-arrow-right"></i></span>Keluar</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
    ...
    <div class="offcanvas offcanvas-start bg-dark text-white sidebar-nav hide" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
            ...
            <nav class="navbar-dark">
                <ul class="navbar-nav">
                    ...
                    <li>
                        ...
                        <a href="ahp.php" class="nav-link px-3">
                            <span class="me-2">
    ...
    <main class="mt-5 pt-3" id="menu-kuisioner">
