...
!(function (e, t) {
  ...
  const Me = () => B() && B().click(),
    ...
    Ne = (t, n, o) => {
      const i = e.innerParams.get(t);
      i &&
        (n.isComposing || 229 === n.keyCode || (i.stopKeydownPropagation && n.stopPropagation(), 'Enter' === n.key ? Fe(t, n, i) : 'Tab' === n.key ? Re(n) : [...qe, ...Ve].includes(n.key) ? Ue(n.key) : 'Escape' === n.key && _e(n, i, o)));
    },
    Fe = (e, t, n) => {
